...
class Puzzle {
      ...
      for (var x = 0; x < this.columns; x++) {
        if (
          ...
          if (
            ...
            console.log('123');
            console.log(this.pieces[x][y].zIndex < maxZIndex);
            console.log(!this.pieces[x][y].isClose());
            if (
  ...
  mousemove(e) {
    if (this.selected != null) {
      ...
      this.selected.x =
        (e.clientX - rect.left) * this.scaleMultiplier - this.selected.offset.x;
      this.selected.y =
        (e.clientY - rect.top) * this.scaleMultiplier - this.selected.offset.y;
    }
